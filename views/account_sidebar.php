...
$sideGroups = [
    'Mi cuenta' => [
        ['tab' => 'hub', 'label' => 'Mi cuenta', 'url' => 'index.php?r=account'],
        ['tab' => 'orders', 'label' => 'Mis pedidos', 'url' => 'index.php?r=account/orders'],
        ['tab' => 'favorites', 'label' => 'Favoritos', 'url' => 'index.php?r=account/favorites'],
        ['tab' => 'reviews', 'label' => 'Mis opiniones', 'url' => 'index.php?r=account/reviews'],
    ],
    'Ajustes' => [
        ['tab' => 'addresses', 'label' => 'Mis direcciones', 'url' => 'index.php?r=account/addresses'],
        ['tab' => 'notifications', 'label' => 'Notificaciones', 'url' => 'index.php?r=account/notifications'],
        ['tab' => 'profile', 'label' => 'Mi perfil', 'url' => 'index.php?r=account/profile'],
    ],
    'Ayuda' => [
        ['tab' => 'help', 'label' => 'Ayuda', 'url' => 'index.php?r=account#ayuda'],
    ],
];
$sideIcons = [
...
<nav class="bagisto-account-nav flex gap-1 overflow-x-auto rounded-2xl border border-slate-200 bg-white/85 p-2 text-sm font-semibold shadow-sm backdrop-blur md:sticky md:top-32 md:flex-col md:overflow-visible" aria-label="Mi cuenta">
  <?php foreach ($sideGroups as $groupLabel => $groupItems): ?>
  <div class="account-nav-group">
    <p class="account-nav-label"><?php echo esc($groupLabel); ?></p>
